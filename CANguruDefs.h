...
// allgemein
const uint16_t wait_time_long = 500;
...
const uint32_t bdrMonitor = 115200;
...
const uint32_t UID_BASE =  0x45009195ULL; // CAN-UID
const uint8_t maxdevice = 99;

const uint8_t DEVTYPE_GFP =  0x00;
const uint8_t DEVTYPE_GB =  0x10;
const uint8_t DEVTYPE_CONNECT =  0x20;
const uint8_t DEVTYPE_MS2 =  0x30;
const uint8_t DEVTYPE_WDEV =  0xE0;
const uint8_t DEVTYPE_CS2 =  0xFF;
const uint8_t DEVTYPE_FirstCANguru =  0x4F;
const uint8_t DEVTYPE_BASE =  0x50;
const uint8_t DEVTYPE_TRAFFICLIGHT =  0x51;
const uint8_t DEVTYPE_SERVO =  0x53;
const uint8_t DEVTYPE_RM =  0x54;
const uint8_t DEVTYPE_LIGHT =  0x55;
const uint8_t DEVTYPE_SIGNAL =  0x56;
const uint8_t DEVTYPE_LEDSIGNAL =  0x57;
const uint8_t DEVTYPE_CANBOOSTER =  0x58;
const uint8_t DEVTYPE_GATE =  0x59;
const uint8_t DEVTYPE_CAR_CAR =  0x5A;
const uint8_t DEVTYPE_CAR_RM =  0x5B;
const uint8_t DEVTYPE_CAR_SERVO =  0x5C;
const uint8_t DEVTYPE_LastCANguru =  0x5F;
 ...
 * Adressbereiche:
*/
const uint16_t MM_ACC = 0x3000;   //Magnetartikel Motorola
const uint16_t DCC_ACC = 0x3800;   //Magbetartikel NRMA_DCC
const uint16_t MM_TRACK =  0x0000;  //Gleissignal Motorola
const uint16_t DCC_TRACK = 0xC000; //Gleissignal NRMA_DCC
